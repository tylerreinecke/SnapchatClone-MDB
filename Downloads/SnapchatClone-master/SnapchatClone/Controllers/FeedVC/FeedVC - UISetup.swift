...
extension FeedVC {
    ...
    func setupNavigationBar() {
        ...
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "Log Out", style: .plain, target: self, action: #selector(callLogOut))
        navigationItem.leftBarButtonItem?.tintColor = .black
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(named: "+"), style: .plain, target: self, action: #selector(addImage))
